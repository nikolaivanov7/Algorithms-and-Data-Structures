...
class Lek {
    ...
    public Lek() {}
    public Lek(String name, String purpose, int price) {
        this.name = name;
...
public class Farmacija {
    public static void main(String[] args) throws IOException {
        ...
        HashMap<Integer,Lek> lekovi = new HashMap<>(n);

        for (int i=0; i<n; i++) {
            String lek = br.readLine();
            String[] pomniza = lek.split(" ");
            String name = pomniza[0];
            String purpose = pomniza[1];
            int price = Integer.parseInt(pomniza[2]);
            Lek l = new Lek(name,purpose,price);
            lekovi.put(i,l);
        }
        ...
        String L = "";
        int min = 1000000;
        for (Map.Entry<Integer,Lek> curr : lekovi.entrySet()) {
            if (curr.getValue().purpose.equals(namena)) {
                if (curr.getValue().price < min) {
                    min = curr.getValue().price;
                    L = curr.getValue().name;
                }
            }
        }
