...
public class Opstina {
    public static void main(String[] args) throws IOException {
        ...
        CBHT<String, Array<Double>> tabela = new CBHT<>(2*n);
        for(int i = 0; i < n; i++)
        {
            ...
            if(tabela.search(parts[0]) == null)
            {
                ...
                tabela.search(parts[0]).element.value.insertLast(Double.valueOf(parts[1]));
            }
            else {
               tabela.search(parts[0]).element.value.insertLast(Double.valueOf(parts[1]));
            }
        ...
        double pm = 0;
        for(int i = 0; i < tabela.search(opstina).element.value.getSize(); i++)
        {
            pm += tabela.search(opstina).element.value.get(i);
        }
        System.out.printf("%.2f",pm/tabela.search(opstina).element.value.getSize());
        }
}
